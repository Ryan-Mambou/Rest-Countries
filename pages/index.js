...
const changeTheme = () => {
  ...
  return (
    <div className={`font-nunito bg-gray-100 dark:bg-slate-900`}>
      <Head>
      ...
      <div className='w-11/12 m-auto mt-40 flex flex-col md:flex-row justify-between items-start md:items-center gap-5 md:gap-0'>
        ...
        <Filter handleDropdown={handleDropdown} closeDropdown={closeDropdown} dropdown={dropdown} setContinentToSort={setContinentToSort} />
        </div>
